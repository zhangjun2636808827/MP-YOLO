...
class MPCBottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        ...
        self.biasconv = Conv(self.c_, c2//4, k[1], s=1,p=0, g=g)
        self.add = shortcut and c1 == c2

    def forward(self, x):
        x1 = self.conv(x)
        y1 = self.biasconv(self.pad1(x1)) 
        y2 = self.biasconv(self.pad2(x1)) 
        y3 = self.biasconv(self.pad3(x1))
        y4 = self.biasconv(self.pad4(x1))
